...
## Corpus Check
- 115 files · ~13,002,981 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3468 nodes · 5608 edges · 406 communities (309 shown, 97 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 131 edges (avg confidence: 0.87)
- Token cost: 75,506 input · 0 output
...
5. `RESULTS: ra_core_singleblock cycle-operation combo search` - 21 edges
...
- **Sequential BCFN-defect fix attempts (prereseed, o-width-fix, cycle-combo-search)** — bcfn_defect_singleblock, experiments_2026_9_2_singleblock_prereseed_experiment, experiments_2026_9_2_singleblock_o_width_fix, experiments_2026_9_2_singleblock_cycle_combo_search_results [INFERRED 0.85]
- **11 Promotion Tier clean winners (all width=8) and their finalizer pattern** — promotion_tier_singleblock, w8_f9_i0_candidate, w8_f33_i0_candidate, dsl_search_space_cycle_combo [INFERRED 0.85]
- **Combo search tooling implementing the DSL search + gating pipeline** — experiments_2026_9_2_singleblock_cycle_combo_search_recipes, experiments_2026_9_2_singleblock_cycle_combo_search_combo_prng, experiments_2026_9_2_singleblock_cycle_combo_search_tier1_search, experiments_2026_9_2_singleblock_cycle_combo_search_promotion_search, experiments_2026_9_2_singleblock_cycle_combo_search_combo_gen [EXTRACTED 1.00]
...
## Communities (406 total, 97 thin omitted)

### Community 0 - "stream"
Cohesion: 0.06
Nodes (59): _log(), main(), phase_a_hash_access_check(), phase_b_greedy_ablation(), Driver for the operation-pruning greedy ablation search. Two phases: Phase A:…, analyze_cycle(), compute_avalanche_matrix(), Reseed-Driven Avalanche Strengthening Effect (+51 more)

### Community 1 - "benchmark_all.c"
Cohesion: 0.08
Nodes (54): chacha20_block(), main(), core_entry_t, FILE, chacha20_block(), find_core(), kat_chacha20(), kat_mt19937() (+46 more)

### Community 2 - "tahap6_bench.c"
Cohesion: 0.08
...
### Community 3 - "Operand Position Search Experiment Results"
Cohesion: 0.07
...
### Community 4 - "Handover: Tahap 5 — Optimasi Biaya Init Addressable"
Cohesion: 0.10
...
Cohesion: 0.13
Nodes (23): main(), main(), core_entry_t, FILE, find_core(), fmix32(), main(), ra_core_orbit() (+15 more)

### Community 10 - "pruned_winner 4-Operation Fast Variant"
Cohesion: 0.13
...
### Community 11 - "RESULTS: fix defect K-kecil `ra_core_singleblock` — perlebar `o` (Kandidat A) + internal warm-up (Kandidat B)"
Cohesion: 0.17
...
### Community 12 - "2026-9-1_production-candidate-battery/RESULTS.md"
Cohesion: 0.19
Nodes (24): core_entry_t, FILE, find_core(), main(), mode_init_cost(), mode_reinit_sweep(), mode_throughput(), now_seconds() (+16 more)

### Community 13 - "Langkah 3: Interleaved 1TB for winner_wired_addressable (shared core-loop test)"
Cohesion: 0.15
...
### Community 14 - "`ra_core_singleblock`: pekerjaan baru, "aggressive reinit" skala produksi"
Cohesion: 0.09
...
Cohesion: 0.13
Nodes (21): Read-only constraint on src/ra_prng2, src/ra_prng3, winner_wired_v2.c, Parallelization Research Results, 1TB Interleaved PractRand Anomaly (3/304 tests flagged, unconfirmed), common.py (shared harness config, TIERS_Q1B), cross_correlation.py, cross_correlation_ra_prng2.py, interleave_practrand.py, interleave_practrand_ra_prng2.py (+13 more)

### Community 17 - "other/avalanche_heatmap_original.py"
Cohesion: 0.12
Nodes (21): BCFN structural defect (K-small), operand_search.py (operation-pruning-research), combo_search_log.jsonl, promotion_log.jsonl / promotion_logs/*.log, RESULTS: ra_core_singleblock cycle-operation combo search, tier0_survivors.jsonl, singleblock-o-width-fix experiment, singleblock-prereseed-experiment (+13 more)

### Community 18 - "winner_wired_v2.c"
Cohesion: 0.16
...
Cohesion: 0.11
Nodes (21): dieharder_pruned_winner_piped.txt, parallelization-research experiment (2026-8-29), HANDOVER_TAHAP6.md, Tahap 6 hard scope limit (rng<=255, hard-abort guard), ra_core_singleblock(), winner_wired_addressable.c, scc_test.py, verify_parity.py (+13 more)

### Community 21 - "tahap5_bench.c"
Cohesion: 0.21
Nodes (19): brent_resumable(), FILE, State, init_state(), load_checkpoint(), main(), next_state(), params_init() (+11 more)

### Community 22 - "ra_core.c"
Cohesion: 0.14
...
### Community 24 - "cross_correlation.py"
Cohesion: 0.17
...
Cohesion: 0.16
Nodes (15): avalanche_stats(), hamming(), Generic per-bit avalanche measurement: flip each of the 32 seed bits, capture…, capture_cycle(), main(), Tahap 2 (family-productionization): avalanche gate for ra_core.c's two…, run_gate(), capture_cycle() (+7 more)
...
### Community 31 - "scrambler_wired_addressable.c (winner_wired_v2 cycle + addressable-init shuffle CLI)"
Cohesion: 0.18
...
### Community 32 - "RESULTS: production-candidate battery for `ra_core.c`"
Cohesion: 0.18
...
### Community 33 - "RaPrng2"
Cohesion: 0.13
Nodes (12): common.py (TIERS_Q2), Path, Langkah 2 of HANDOVER_1TB_FOLLOWUP.md: re-run the interleaved 1TB Method B test…, run_live(), main(), Q1 Method B: interleave K independent `--stream <seed> <n>` streams word-by-…, run_interleave_practrand(), Path (+4 more)

### Community 34 - "toy_prng.py"
Cohesion: 0.15
...
### Community 35 - "avalanche_heatmap_pruned_winner.py"
Cohesion: 0.14
...
### Community 38 - "stream_driven_shuffle.c"
Cohesion: 0.12
...
### Community 39 - "benchmark_all_run.py"
Cohesion: 0.26
...
### Community 40 - "diag_keyzero_guard.c"
Cohesion: 0.17
Nodes (14): pruned_prng.c, build_o() (original 8-tap formula), Production-Candidate Battery Gate, main(), Singleblock O-Width Fix Handover, K-kecil Singleblock Structural Defect, 'o' Mixing Variable (2-tap vs 8-tap), Candidate A: Widen o to 8-tap (+6 more)

### Community 41 - "Karakterisasi ambang K minimum aman — `ra_core_singleblock`"
Cohesion: 0.22
...
### Community 42 - "quality_gate.py (avalanche_stats)"
Cohesion: 0.20
...
### Community 44 - "io_only_isolation_test.c"
Cohesion: 0.27
...
### Community 54 - "Singleblock o-Width Fix RESULTS"
Cohesion: 0.32
...
### Community 57 - "Results: Periodicity Heuristic Validation 2 (Pruned & Rewired `winner_wired_v2`)"
Cohesion: 0.15
...
### Community 64 - "ablation_search.py"
Cohesion: 0.29
...
### Community 67 - "tahap4_benchmark.py"
Cohesion: 0.33
...
### Community 68 - "scrambler_addressable.c"
Cohesion: 0.25
...
### Community 71 - "diag_hashed_init.c"
Cohesion: 0.38
...
### Community 72 - "diag_orbit_regression.c"
Cohesion: 0.27
...
### Community 73 - "verify_fresh_build.py"
Cohesion: 0.36
...
### Community 81 - "pruned_winner_refactored.c"
Cohesion: 0.44
...
### Community 96 - "winner_wired.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 97 - "2026-8-28_periodicity-heuristic-validation2/enumerate_n4w4.py"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 98 - "original_inject.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 99 - "original_m_inject.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 100 - "original_m_overwrite.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 101 - "original_m_permute.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 102 - "original_overwrite.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 103 - "original_permute.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 104 - "winner_inject.c"
Cohesion: 0.33
...
### Community 105 - "winner_m_inject.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 106 - "winner_m_overwrite.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 107 - "winner_m_permute.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 108 - "winner_overwrite.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 109 - "winner_permute.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 110 - "Handover: 1TB interleaved-PractRand anomaly follow-up"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 111 - "winner_wired_addressable_v2.c"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()
...
### Community 126 - "HANDOVER: fix defect K-kecil `ra_core_singleblock` — perlebar `o` ke 8-tap, fallback internal-warmup"
Cohesion: 0.50
...
### Community 136 - "ent (Entropy Testing Tool)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 137 - "pcg32.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 138 - "src/xoshiro256.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 139 - "xoshiro256_amortized.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 140 - "scrambler.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 141 - "2026-8-25_periodicity-heuristic-validation/run_sweep.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 142 - "2026-8-28_periodicity-heuristic-validation2/avalanche_check.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 143 - "simd_prototype.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 144 - "RESULTS: Dieharder "Good" Battery for `winner_wired_v2` and `winner_wired_addressable`"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 145 - "PRNG Periodicity Analysis"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 146 - "source/chacha20.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 147 - "chacha20_amortized.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()
...
### Community 149 - "source/xoshiro256.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 150 - "Shuffling perf stat (ra_prng2 original)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 151 - "init_kandidat1"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 152 - "run_dieharder_battery.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 153 - "run_dieharder_battery_multikey.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 154 - "verify_unification.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 155 - "test_ra_hash.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 156 - "Avalanche Effect Comparison Heatmap (pruned_winner Cycle 1 vs Cycle 2)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 157 - "avalanche_gate"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 158 - "auto_stop_power38.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()
...
### Community 160 - "Orbit Addressing"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 161 - "Parallelization Research Handover"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 162 - "avalanche_orbit_singleblock_k255.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 163 - "scrambler_ra_core_singleblock.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 164 - "Avalanche Effect Analysis (ALL_OPS)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 165 - "heatmap.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 166 - "ra_prng2.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 167 - "c/ra_prng3.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 168 - "Cycle 3 Avalanche Fraction (0.470588)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 169 - "Paper heuristic λ ≈ 0.7824·√|S|"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 170 - "Tap-survivor generalization (top-2-by-count rule, G=8→(6,7))"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 171 - "Core Hypothesis: invariant L-multiset carries address fingerprint, M/cons carries avalanche"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 172 - "robust_reinit.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 173 - "avalanche_ra_core_singleblock_k1.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 174 - "Avalanche Effect Heatmap (Original Algorithm)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 175 - "Graphify Knowledge Graph Rule"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 176 - "dev_urandom.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 177 - "Graphify-First Research Workflow Policy"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 178 - "Cycle 1 vs Cycle 5 Avalanche Fraction Convergence"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 179 - "Avalanche Effect Heatmap: pruned_winner (TAP6, TAP7, ROT_C, SHR13)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 180 - "Greedy Operation-Pruning Search Paradigm"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 181 - "collision_scan.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 182 - "Q3: Multi-process throughput scalability"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 183 - "pcg.c (PCG32 comparison binary)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 184 - "xoshiro256.c (fread+tokenizer comparison binary)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 185 - "run_speed_benchmark.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 186 - "verify_parity.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 187 - "verify_parity_wired.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()
...
### Community 189 - "Original Algorithm Avalanche Bit Distribution & Diffusion"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 190 - "other_winners_perf.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 191 - "other_winners_practrand.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 192 - "perf_state_update.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 193 - "perf_state_update_m.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 194 - "toy_probe_phase3.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 195 - "toy_sweep_m.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 196 - "toy_sweep_phase3.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 197 - "perf_scaling.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 198 - "Q4: SIMD vectorization microbenchmark (stretch goal)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 199 - "Kandidat 5 (user candidate, adopted)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 200 - "Dieharder Orbit Regression Raw Output"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 201 - "bench_ra_core Throughput/Reinit-Sweep Results Log"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 202 - "BUILD.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 203 - "multikey_stream_singleblock_k1.c"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 204 - "run_confirm_16gb.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 205 - "run_extended_16gb.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 206 - "run_warmup_triage.sh"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 207 - "CI Build and Test Job"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 208 - "conftest.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 209 - "Addressable-Init Research (Tahap 0-5)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 210 - "/dev/urandom RNG Speed Benchmark Result"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 211 - "PCG32 RNG Speed Benchmark Result"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 212 - "Philox4x32 RNG Speed Benchmark Result"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 213 - "xoshiro256** RNG Speed Benchmark Result"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 214 - "benchmarks/comparisons/source/README.md (naming convention)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 215 - "cpython/__init__.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 216 - "bindings/__init__.py"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 217 - "Project Root Changelog"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 218 - "2025-10-5_scramble-design/scrambler.c (predecessor)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 219 - "rows=2 Configuration Log"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 220 - "Design decision: op/wiring mapping ported to toy scale"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 221 - "rerun_n8_w4_rows4_stderr.txt"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 222 - "rerun_n8_w4_rows4_stdout.txt"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 223 - "Finding: very short transient tail (μ<=1) across all seeds"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 224 - "Sweep Output (empty file)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 225 - "Cross-Correlation Singleblock Postfix Run Log"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 226 - "Q1: Cross-stream independence"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 227 - "Kandidat 1 (L=f(seed,counter) splitmix, M unchanged)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 228 - "Kandidat 2 (L and M independently keyed)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 229 - "Kandidat 4 (L mult from seed, additive counter term)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 230 - "Kandidat 2: independent L/M keying"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 231 - "Kandidat 1"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 232 - "Kandidat 2"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 233 - "Kandidat 4"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 234 - "v0_baseline (control init)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 235 - "8. Setelah mengerjakan follow-up di atas"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 236 - "Addressable-Init Shuffle Handover"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 237 - "I/O text parsing as root cause of ~2.2x slowdown"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 238 - "io_only_isolation_test.c (I/O cost isolation diagnostic)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 239 - "I/O optimization: fread + manual tokenizer + fwrite (done)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 240 - "Rename ra_core to ra_shuffle (done)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 241 - "ra_shuffle (renamed shuffle function, formerly ra_core)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 242 - "scc_test.py (statistical & distinctness validation)"
Cohesion: 0.44
Nodes (8): FILE, fmix32(), main(), now_seconds(), ra_core_singleblock_combo(), ra_init_state_singleblock(), ra_permutation_cycle_singleblock_combo(), rot32()

### Community 243 - "scrambler_addressable (Shuffle CLI)"
Cohesion: 0.22
...
### Community 244 - "speed_bench/ benchmark harness"
Cohesion: 0.44
Nodes (8): RA_PRNG, main(), ra_hash(), ra_prng_advance(), ra_prng_init(), ra_prng_next(), ra_step(), rot32()

### Community 245 - "stream_driven_shuffle.c (single-swap hypothesis test CLI)"
Cohesion: 0.42
Nodes (8): FILE, main(), ra_core(), ra_hash(), ra_init_state(), ra_permutation_cycle(), ra_reseed(), rot32()

### Community 246 - "verify_parity.py (C vs Python parity check)"
Cohesion: 0.29
...
### Community 247 - "Multi-key distinctness spot-check (200 keys, 0 collisions)"
Cohesion: 0.36
...
### Community 248 - "Orbit Addressing integrated into shuffle state init"
Cohesion: 0.32
...
### Community 249 - "Parity validation (63/63 PASS, C vs Python bit-identical)"
Cohesion: 0.25
Nodes (6): Tahap 6: no-L[] fast path (rng<=255), PRNG Family Benchmark Handover, Candidate: MT19937, Candidate: addressable agresif K=1 (singleblock), Finding: MT19937 seeding cost dominates frequent-reseed workloads, Official MT19937 reference (Matsumoto & Nishimura, mt19937ar.c)

### Community 250 - "Speed summary: ZepFold ~2.2x slower, root cause is I/O"
Cohesion: 0.25
Nodes (8): 1. Status & tujuan, 2. Formula & fakta struktural (sudah final, tidak perlu digali ulang), 3. Temuan disassembly (sudah dijalankan read-only, sesi persiapan 2026-08-30), 5. Rencana file & eksperimen, 6. Gerbang validasi statistik (aturan mekanis, bukan penilaian bebas), 7. Batasan read-only (berlaku juga untuk Tahap 5), 8. Kondisi berhenti / pelaporan eksplisit, Handover: Tahap 5 — Optimasi Biaya Init Addressable

### Community 251 - "Statistical validation (entropy/chi2/runs/SCC, no regression)"
Cohesion: 0.25
Nodes (8): 1. Trigger dan motivasi, 2. Analisis (dikonfirmasi sebelum menulis kode apa pun), 3. File & perannya, 4. Batas scope keras (WAJIB dibaca sebelum memakai `ra_core_singleblock`), 5. Hasil kunci (angka lengkap di `RESULTS.md` "## Tahap 6"), 6. Status & langkah selanjutnya, 7. Setelah mengerjakan follow-up di atas, Handover: Tahap 6 -- fast path addressable tanpa `L[]` untuk `rng <= 255`

### Community 252 - "ra_core (shuffle loop, scrambler_addressable.c)"
Cohesion: 0.50
Nodes (7): FILE, fmix32(), main(), ra_core_avalanche_init(), ra_init_state_avalanche(), ra_permutation_cycle_orbit(), rot32()

### Community 253 - "ra_hash (block-reseed, 255-element)"
Cohesion: 0.50
Nodes (7): FILE, fmix32(), main(), ra_core_keyterm_add(), ra_init_state_keyterm_add(), ra_permutation_cycle_orbit(), rot32()

### Community 254 - "scrambler_addressable.py (Python reference port)"
Cohesion: 0.50
Nodes (7): FILE, fmix32(), main(), ra_core_keyterm_xor(), ra_init_state_keyterm_xor(), ra_permutation_cycle_orbit(), rot32()

### Community 255 - "Shuffled Token Output"
Cohesion: 0.46
Nodes (7): _log(), main(), n_words_for_mb(), Path, Tier 1: multikey PractRand staged gate, K=1 (worst-case documented in…, run_candidate(), run_practrand()

### Community 256 - "Speed Benchmark Output (chacha20)"
Cohesion: 0.25
...
### Community 257 - "Speed Benchmark Output (philox)"
Cohesion: 0.29
...
### Community 263 - "load_tokens_from_file (fscanf per-token -> fread+tokenizer)"
Cohesion: 0.38
...
### Community 264 - "no_reseed_isolation_test.c (diagnostic-only, reseed removed)"
Cohesion: 0.38
...
### Community 265 - "philox.c (Philox4x32 comparison binary)"
Cohesion: 0.48
Nodes (6): main(), rot32_avx2(), rot32_scalar(), run_scalar(), run_simd(), __m256i

### Community 266 - "ra_core(key, rng, raw_stream) — renamed to ra_shuffle"
Cohesion: 0.29
Nodes (7): PRNG Family Benchmark Results, Closing note, K=1 (frequent reinit) vs largest-K (steady state), sorted by K=1 cost ascending, MB/s sanity check, sorted descending, Seeding cost — OLS fit `call_ns(K) = a + b·K`, sorted by fixed cost `a` ascending, Topline answer, Validation

### Community 267 - "ra_init_state_addressable(key)"
Cohesion: 0.29
...
### Community 268 - "run_speed_benchmark.sh (perf stat -r 30 over 12 binaries)"
Cohesion: 0.29
...
### Community 269 - "save_tokens_to_file (fprintf per-token -> single fwrite)"
Cohesion: 0.53
Nodes (4): chacha20_block(), chacha20_next(), main(), rand_bounded()

### Community 270 - "scrambler_addressable (addressable-init shuffle CLI)"
Cohesion: 0.47
Nodes (4): chacha20_block(), main(), rand_bounded(), Speed Benchmark Output (chacha20 amortized)

### Community 271 - "single_mread_isolation_test.c (diagnostic-only, 1-elem M[] read)"
Cohesion: 0.67
Nodes (5): pcg32_random_t, main(), pcg32_random_r(), pcg32_srandom(), rand_bounded()

### Community 272 - "Single-run benchmark variance caution (stream_driven_shuffle ±8.27%)"
Cohesion: 0.60
Nodes (5): main(), rand_bounded(), rotl(), xoshiro256_init(), xoshiro256_next()

### Community 273 - "stream_driven_shuffle.c (single-swap Fisher-Yates driven by ra_core)"
Cohesion: 0.67
...
### Community 274 - "winner_wired_addressable.c (source of ra_core generator)"
Cohesion: 0.33
...
### Community 275 - "tokens.txt sample data (100,000 tokens)"
Cohesion: 0.40
...
### Community 276 - "dieharder ra_core_singleblock multikey piped results"
Cohesion: 0.60
Nodes (5): main(), Path, Track A of the 2026-09-01 idle-VPS-capacity plan: dieharder "Good"- reliability…, run_one(), run_test()

### Community 277 - "Avalanche Orbit/Singleblock K=255 Rerun Log"
Cohesion: 0.60
Nodes (5): main(), Path, Track A of the 2026-09-01 idle-VPS-capacity plan: dieharder "Good"- reliability…, run_one(), run_test()

### Community 278 - "Avalanche Singleblock K=1 Log"
Cohesion: 0.60
Nodes (5): compile_new(), compile_old(), main(), run_stream_new(), run_stream_old()

### Community 279 - "Orbit Addressing (f(key) state-init mechanism)"
Cohesion: 0.33
...
### Community 284 - "ZepFold (token-shuffling CLI approach)"
Cohesion: 0.70
Nodes (4): fisher_yates_k1(), main(), pull_n(), pull_one()

### Community 285 - "PRNG Family Benchmark Results"
Cohesion: 0.60
...
### Community 286 - "RESULTS: `ra_core_singleblock` cycle-operation combo search"
Cohesion: 0.50
...
### Community 287 - "Tahap 2: Folder/Battery Validasi Produksi"
Cohesion: 0.70
Nodes (4): main(), rot32(), ZepFold(), ZepXORhash()

### Community 288 - "avalanche_heatmap_winner.py"
Cohesion: 0.70
Nodes (4): main(), ra_core(), ra_hash(), rot32()

### Community 289 - "avalanche_heatmap_winner_v2.py"
Cohesion: 0.70
Nodes (4): main(), rot64(), ZepFold(), ZepXORhash()

### Community 290 - "Wiring"
Cohesion: 0.83
...
### Community 291 - "diag_wideo_warmup_singleblock.c"
Cohesion: 0.50
...
### Community 292 - "RESULTS: key=0 degenerate-state guard-XOR fix"
Cohesion: 0.50
...
### Community 293 - "promotion_search.py"
Cohesion: 0.67
...
## Knowledge Gaps
- **458 isolated node(s):** `Threefry2x32`, `xoshiro256**`, `fmix32`, `Kandidat A — hasil per K`, `Kandidat B — konfirmasi skala penuh (N ∈ {1,4}, K ∈ {1,2,4,8,16}, 16GB)` (+453 more)
...
- **Why does `RESULTS: ra_core_singleblock cycle-operation combo search` connect `other/avalanche_heatmap_original.py` to `stream`, `Completed Tasks`, `diag_hashed_init.c`, `diag_keyzero_guard.c`, `Singleblock Cycle-Operation Combo Search Handover`, `pruned_winner.c`, `Design decisions (read before touching `pruned_wired_toy_prng.py`)`, `ra_core.c`, `Shuffled Token Output`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Singleblock O-Width Fix Handover` connect `diag_keyzero_guard.c` to `Avalanche Effect (Bit-Flip Sensitivity)`, `scrambler_addressable (Shuffle CLI)`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `ra_core_singleblock()` connect `2026-8-28_periodicity-heuristic-validation2/cycle_measure.c` to `Parity validation (63/63 PASS, C vs Python bit-identical)`, `winner_wired_v2.c`, `2026-9-1_production-candidate-battery/RESULTS.md`, `quality_gate.py (avalanche_stats)`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
...
- **What connects `Threefry2x32`, `xoshiro256**`, `fmix32` to the rest of the system?**
