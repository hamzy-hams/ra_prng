// w4_f2_i0.c -- auto-generated by combo_gen.py, DO NOT EDIT BY HAND
// width=4 finalizer=[MUL(0xc2b2ae35)] inject_off
...
int main(int argc, char **argv) {
    ...
    if (argc >= 2 && strcmp(argv[1], "--bench") == 0 && argc >= 4) {
        ...
        printf("w4_f2_i0 K %lld cycles %lld ns_per_word %.4f\n", k, cycles, ns_per_word);
        return 0;
    }
    fprintf(stderr,
        "usage:\n"
